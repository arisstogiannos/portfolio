...
export default function CursorDesktop({ cursorScale }) {
  ...
  return (
    <div
      ref={cursor}
      className={`work w-32 h-32 fixed bg-mblue pointer-events-none -translate-x-1/2 -translate-y-1/2 -z-[1000] filter  transition-transform duration-300 ease-in-out ${
        cursorScale ? "scale-[3.9] blur-xl rounded-full" : "scale-[0.1] rounded-full"
